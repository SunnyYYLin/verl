...
os.environ["HF_HOME"] = "/vepfs-mlp2/mlp-public/zhongcuiting/tmp/hf/huggingface"
os.environ["HF_DATASETS_CACHE"] = "/vepfs-mlp2/mlp-public/zhongcuiting/tmp/hf/datasets"
    ...
    def process_fn(example, idx):
        ...
        data = {
            ...
            'extra_info': {
                ...
                'distance': distance,
                'data_source': source,
                'TSS':example.get('gene_tss'),
                'CRE_center': example.get('cre_center'),
                'chr': example.get('chr'),
                'id': example.get('id'),
            },
        }
